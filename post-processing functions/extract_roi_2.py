...
img_id = []
for infile in sorted(glob.glob(r'C:\My data\sateg0\valid\img\*.npy')):
    img_id.append(infile)


img_path=r'C:/Users/Abbas Khan/Desktop/PROS/nw_data/val/img/'
gt_path=r'C:/Users/Abbas Khan/Desktop/PROS/nw_data/val/gt/'

img_path = os.path.join(img_path)
gt_path = os.path.join(gt_path)


def proc_(img,gt_LA,gt_sc,name):
...
g=np.load(r'C:\Users\Abbas Khan\Desktop\PROS\nw_data\val\gt\train_9_31_gt.npy')
i=np.load(r'C:\Users\Abbas Khan\Desktop\PROS\nw_data\val\img\train_9_31.npy')


# print(np.sum(g))

o1=np.load(r'C:\My data\sateg0\valid\sc_gt\train_9_31sc_gt.npy')
o2=np.load(r'C:\My data\sateg0\valid\img\train_9_31.npy')

#o3=np.load(r'C:\My data\sateg0\train\seg_gt\train_7_31_gt.npy')
